...
export default function Layout({ overlayContent, children, transparentUntil }: Props) {
   ...
   return (
      <ThemeProvider theme={theme}>
         ...
         >
            <div>
               <CssBaseline />
               <Header transparent={!!transparentUntil} fixed transparentUntil={transparentUntil} />
